...
import static fr.emse.ai.csp.core.LeastConstrainingValue.orderLeastConstrainingValue;
import static fr.emse.ai.csp.core.MinRemainingValues.selectMinRemainingValues;
...
public class BacktrackingStrategy extends SolutionStrategy {
    ...
    private Assignment recursiveBackTrackingSearch(CSP csp,
        ...
        /**
         * ça ne sert à rien pour le problème des N Reines car le graphe est complet !
         */
        AC3Strategy acs = new AC3Strategy();
        acs.reduceDomains(csp);
